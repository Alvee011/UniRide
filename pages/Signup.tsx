...
export const Signup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <div className="p-6 pt-8 flex items-center relative">
      ...
      <div className="flex-1 px-8 flex flex-col justify-center">
        <h2 className="text-2xl font-bold text-center mb-10">Create an Account?</h2>
        ...
        <div className="space-y-5">
             ...
             <div>
                ...
                <div className="relative">
                    <input 
                        type="text" 
                        placeholder="Faruque Azam Alvee" 
            ...
            <div>
             ...
             {/* Confirm Password (Visual Only based on design feeling) */}
             <div>
                <label className="block text-xs font-bold text-slate-500 mb-2 ml-1">Confirm Password</label>
                <div className="relative">
                    <input 
                        type={showPassword ? "text" : "password"}
                        placeholder="********" 
        ...
        <div className="flex items-center gap-2 mt-6 mb-8">
            <input type="checkbox" id="remember_signup" className="w-4 h-4 accent-primary-500 rounded border-gray-300" />
            <label htmlFor="remember_signup" className="text-sm text-slate-500">Remember me</label>
        </div>
        ...
        <div className="flex justify-center gap-6 mb-8">
            <button className="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center border border-gray-100 hover:bg-gray-100 transition-colors">
             ...
             <button className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center border border-blue-100 hover:bg-blue-100 transition-colors text-blue-600">
               <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.954 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.79-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </button>
        ...
        <div className="text-center pb-6">
            ...
            <button onClick={() => navigate('/login')} className="text-slate-800 font-bold text-sm hover:underline">Login</button>
        </div>
